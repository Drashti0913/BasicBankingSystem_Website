...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-4" style="background-color : #7d8892;">
              
              <div class="col-sm-12 col-md img text-center">
                <img src="img/bank.png" class="h-auto max-w-full">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="removeuser.php"><button style="background-color : #2785C4;" style="border-radius:0%">Users</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2023 Made by <b>DRASHTI BHAVSAR</b></p>
      </footer>
